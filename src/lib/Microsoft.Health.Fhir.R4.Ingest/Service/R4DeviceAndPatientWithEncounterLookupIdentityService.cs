...
namespace Microsoft.Health.Fhir.Ingest.Service
{
    ...
    {
        public R4DeviceAndPatientWithEncounterLookupIdentityService(ResourceManagementService resourceIdService)
            : base(resourceIdService, ResourceIdentityServiceType.LookupWithEncounter)
        {
        }
