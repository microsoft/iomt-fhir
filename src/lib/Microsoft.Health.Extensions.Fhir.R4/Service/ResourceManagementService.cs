...
namespace Microsoft.Health.Extensions.Fhir.Service
{
    public class ResourceManagementService
    {
        ...
        public IFhirServerRepository FhirServerRepository { get; private set; }
            ...
            where TResource : Model.Resource, new()
        {
            ...
            var result = await FhirServerRepository.SearchForResourceAsync<TResource>(searchParams).ConfigureAwait(false);
